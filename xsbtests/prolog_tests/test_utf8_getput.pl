...
test:- test_code_for_atom('1こんaにちは今今的z'),fail.
test:- test_char_for_atom('1こんaにちは今今的z'),fail.
%test:- test_byte_for_atom('1こんaにちは今今的z'),fail.
test:- test_peek_char_for_atom('1こんaにちは今今的z'),fail.
test:- test_peek_code_for_atom('1こんaにちは今今的z'),fail.
test.
