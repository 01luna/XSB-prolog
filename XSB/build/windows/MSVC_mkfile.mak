...
#
# Usage:
#   NMAKE /f "MSVC_Mfile.mak" CFG="option" [DLL="yes"] [ORACLE="yes"] [MY_LIBRARY_DIRS=="addl libs"]
#
...
#                          and/or InterProlog)
#
# Note: Specifying any non-zero string for ORACLE means "yes"!
...
!MESSAGE
!MESSAGE NMAKE /f "MSVC_Mfile.mak" CFG="debug"
!MESSAGE
...
!MESSAGE For example:
!MESSAGE
!MESSAGE NMAKE /f "MSVC_Mfile.mak" CFG="debug" DLL="yes"
!MESSAGE
...
### If you have custom directories to use for #include or DLLs,
### create the file custom_directories.mak and put these lines there
### MY_INCLUDE_DIRS=my_include_directory1 my_include_directory2 ...
### MY_LIBRARY_DIRS=my_library_directory1 my_library_directory2 ...

!IF EXIST("custom_directories.mak")
...
#!MESSAGE Usage:
#!ERROR NMAKE /f "MSVC_Mfile.mak" CFG="..." INTERPROLOG=1 SITE_LIBS="interprolog libs"
#!ENDIF
!ENDIF
