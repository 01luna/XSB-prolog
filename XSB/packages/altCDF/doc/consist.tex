...
%------------------------------------------------------------------------------------
\ \\
\>  \underline{LocalClassExpression($Id: consist.tex,v 1.1 2005-04-12 23:48:59 tswift Exp $)}  \\
...
\\
%------------------------------------------------------------------------------------
\>  \underline{LocalClassFormula($Id: consist.tex,v 1.1 2005-04-12 23:48:59 tswift Exp $)}  \\
\> \> Let $\cF = getRelevantFacts(Id)$ \\
\> \> If $Id: consist.tex,v 1.1 2005-04-12 23:48:59 tswift Exp $ is a class identifier, CF = $elt(X_0,Id)$ \\
\> \> Else If $Id: consist.tex,v 1.1 2005-04-12 23:48:59 tswift Exp $ is an object identifier $oid(I)$ \\
\> \> \> CF = $elt(X_0,cid(I)) 
...
for an identifier $Id: consist.tex,v 1.1 2005-04-12 23:48:59 tswift Exp $ begins with obtaining all of the facts relevant
to $Id: consist.tex,v 1.1 2005-04-12 23:48:59 tswift Exp $, as described by the routine {\sf getRelevantFacts($Id: consist.tex,v 1.1 2005-04-12 23:48:59 tswift Exp $)}.
...
A local class expression for a given class or object identifier, $Id: consist.tex,v 1.1 2005-04-12 23:48:59 tswift Exp $,
is constructed by the routine {\sf LocalClassExpression(Id)}, which
begins by calling {\sf getRelevantFacts($Id: consist.tex,v 1.1 2005-04-12 23:48:59 tswift Exp $)} to obtain the set of
facts $\cF$ relevant to $Id: consist.tex,v 1.1 2005-04-12 23:48:59 tswift Exp $.  Each fact in $\cF$ is translated to a
...
{\sf getRelevantFacts($Id: consist.tex,v 1.1 2005-04-12 23:48:59 tswift Exp $)}.  In addition, it is an easy induction to
show that for any identifier $Id: consist.tex,v 1.1 2005-04-12 23:48:59 tswift Exp $ in a CDF instance, {\sc
...
Let $\cO$ be a well-typed, acceptable CDF instance, $Id: consist.tex,v 1.1 2005-04-12 23:48:59 tswift Exp $ be an object
or class identifier in $\cO$, $\cO_{Id}$ be {\sf
getRelevantFacts($Id: consist.tex,v 1.1 2005-04-12 23:48:59 tswift Exp $)}, and $\cO_{isa}$ be the {\tt isa/2} facts
in $\cO$.
\begin{itemize}
...
identifier $Id: consist.tex,v 1.1 2005-04-12 23:48:59 tswift Exp $ in a CDF instance $\cO$ is presented schematically in
Figure~\ref{fig:type1cc}.  We assume that $\cO$ is well-typed and
acceptable.  The algorithm begins with a call {\sf
checkIdConsistency(\{$Id: consist.tex,v 1.1 2005-04-12 23:48:59 tswift Exp $\})}.  As indicated in the previous
discussion, {\sf checkIdConsistency(\{$Id: consist.tex,v 1.1 2005-04-12 23:48:59 tswift Exp $\}} first transforms
information about $Id: consist.tex,v 1.1 2005-04-12 23:48:59 tswift Exp $ into a local class expression; then checks
consistency of the local class expression, and constructs new local
class expressions as needed.  Note that {\sf
localClassExpression($Id: consist.tex,v 1.1 2005-04-12 23:48:59 tswift Exp $)} automatically transforms object
identifiers into classes with uniqueness constraints, so {\sf
checkIdConsistency(\{$Id: consist.tex,v 1.1 2005-04-12 23:48:59 tswift Exp $\})} can be applied to object identifiers as
well as class identifiers.  In addition, as Figure~\ref{fig:lcelcf}
indicates, {\sf localClassExpression($Id: consist.tex,v 1.1 2005-04-12 23:48:59 tswift Exp $)} also handles class
...
\> \> 	Let $CSExpr$ be $\bigwedge_{Id \in CSet} \{$ 
			LocalClassExpr($Id: consist.tex,v 1.1 2005-04-12 23:48:59 tswift Exp $) $\}$,  \\
...
%------------------
\begin{definition}
 Let $\cO$ be a CDF instance.  An identifier $Id: consist.tex,v 1.1 2005-04-12 23:48:59 tswift Exp $ {\em directly
