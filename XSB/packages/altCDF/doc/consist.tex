...
for an identifier $Id: consist.tex,v 1.3 2010-08-18 03:10:29 spyrosh Exp $ begins with obtaining all of the facts relevant
to $Id: consist.tex,v 1.3 2010-08-18 03:10:29 spyrosh Exp $, as described by the routine {\sf getRelevantFacts($Id: consist.tex,v 1.3 2010-08-18 03:10:29 spyrosh Exp $)}.
...
A local class expression for a given class or object identifier, $Id: consist.tex,v 1.3 2010-08-18 03:10:29 spyrosh Exp $,
is constructed by the routine {\sf LocalClassExpression(Id)}, which
begins by calling {\sf getRelevantFacts($Id: consist.tex,v 1.3 2010-08-18 03:10:29 spyrosh Exp $)} to obtain the set of
facts $\cF$ relevant to $Id: consist.tex,v 1.3 2010-08-18 03:10:29 spyrosh Exp $.  Each fact in $\cF$ is translated to a
...
{\sf getRelevantFacts($Id: consist.tex,v 1.3 2010-08-18 03:10:29 spyrosh Exp $)}.  In addition, it is an easy induction to
show that for any identifier $Id: consist.tex,v 1.3 2010-08-18 03:10:29 spyrosh Exp $ in a CDF instance, {\sc
...
Let $\cO$ be a well-typed, acceptable CDF instance, $Id: consist.tex,v 1.3 2010-08-18 03:10:29 spyrosh Exp $ be an object
or class identifier in $\cO$, $\cO_{Id}$ be {\sf
getRelevantFacts($Id: consist.tex,v 1.3 2010-08-18 03:10:29 spyrosh Exp $)}, and $\cO_{isa}$ be the {\tt isa/2} facts
in $\cO$.
\begin{itemize}
...
identifier $Id: consist.tex,v 1.3 2010-08-18 03:10:29 spyrosh Exp $ in a CDF instance $\cO$ is presented schematically in
Figure~\ref{fig:type1cc}.  We assume that $\cO$ is well-typed and
acceptable.  The algorithm begins with a call {\sf
checkIdConsistency(\{$Id: consist.tex,v 1.3 2010-08-18 03:10:29 spyrosh Exp $\})}.  As indicated in the previous
discussion, {\sf checkIdConsistency(\{$Id: consist.tex,v 1.3 2010-08-18 03:10:29 spyrosh Exp $\}} first transforms
information about $Id: consist.tex,v 1.3 2010-08-18 03:10:29 spyrosh Exp $ into a local class expression; then checks
consistency of the local class expression, and constructs new local
class expressions as needed.  Note that {\sf
localClassExpression($Id: consist.tex,v 1.3 2010-08-18 03:10:29 spyrosh Exp $)} automatically transforms object
identifiers into classes with uniqueness constraints, so {\sf
checkIdConsistency(\{$Id: consist.tex,v 1.3 2010-08-18 03:10:29 spyrosh Exp $\})} can be applied to object identifiers as
well as class identifiers.  In addition, as Figure~\ref{fig:lcelcf}
indicates, {\sf localClassExpression($Id: consist.tex,v 1.3 2010-08-18 03:10:29 spyrosh Exp $)} also handles class
...
\> \> 	Let $CSExpr$ be $\bigwedge_{Id \in CSet} \{$ 
			LocalClassExpr($Id: consist.tex,v 1.3 2010-08-18 03:10:29 spyrosh Exp $) $\}$,  \\
...
%------------------
\begin{definition}
 Let $\cO$ be a CDF instance.  An identifier $Id: consist.tex,v 1.3 2010-08-18 03:10:29 spyrosh Exp $ {\em directly
