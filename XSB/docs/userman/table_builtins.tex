...
particular form of) tabling.  Executed as a directive in a state of
execution where no clauses exist for each denoted predicate {\tt
  table/1} ensures that any clauses asserted each predicate use
tabling.  {\tt Operations} can take one of three forms:
%
\begin{enumerate}
