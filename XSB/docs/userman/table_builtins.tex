...
Such a predicagte allows XSB to function in a manner similar to that
...
\ei 
%
The argument may be specified either as a list ({\tt
...
predicate, $Pred$, and if the $Pred$ has any incomplete subgoals, no
