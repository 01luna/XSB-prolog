...
any incrementally maintained tables as invalid (in need of updating).
The tables may be updated by an explicit call to {\tt
  incr\_table\_update/[0,1,2]}, or the table will be dynamically
recomputed when a query is made to it.    
...
update.  Beginning with \version{}, this predicate need not be called,
however, as tables will be incrementally updated upon demand.
