...
\subsection{Changing the Default Search Path and the Packaging System} \label{sec:search-path}
%=========================================================
%\begin{description}
...
The system directory \verb|$XSB_DIR/packages| has a number of examples
%%$
