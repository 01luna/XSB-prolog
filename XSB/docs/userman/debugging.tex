...
\item When a set $\cS$ of subgoals is determined to be completely
  ...
  $\cS$.
%
\index{early completion of subgoals}
...
characteristic of most Flora-2 comptuations), It also shows that the
...
\ourmoditem{get\_scc\_length(?Index,?Length)}{get\_scc\_length/3}{tables}
%
