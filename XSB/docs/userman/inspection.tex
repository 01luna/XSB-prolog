...
\subsection{Summary: Inpsection Predicates}
...
tripwires may may additionally be considered as inspection points, and
...
\item {\em One or more subgoals has an unbounded number of answers.}
  ...
  be declared at a predicate-by-predocate basis.  In other words, when
