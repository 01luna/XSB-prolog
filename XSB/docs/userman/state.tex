...
\item {\tt max\_memory} The maximum amount of memory (in kilobytes)
  that XSB can use for its execution stacks, program space, tables, or
  any other purpose.  If a query exceeds this amount, XSB will abort
  the query with a resource exception and then try to reclaim space
  used by the query.
