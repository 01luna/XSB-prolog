...
\end{verbatim}
  ...
  When the limit is set to 0, this this tripwire is disabled.  The
...
\item {\tt max\_incomplete\_subgoals} A limit set on the maximum
  ...
  program.  When the limit is set to 0, this this tripwire is
...
\item {\tt max\_sccs\_subgoals} A limit set on the maximum number of
  ...
  HiLog.  When the limit is set to 0, this this tripwire is disabled.
...
\item {\tt max\_answers\_for\_subgoal} A limit set on the number of
  ...
  symbols, it is possible to construct can be very many atoms of a
  ...
  is set to 0, this this tripwire is disabled.  The default value is
  {\tt 0}.
