...
\begin{itemize}
\item{\em Execition Type} which can be one of
\begin{itemize}
...
%
\item{\tt tabled} The predicate has been declared tabled.
%
\item{\tt incremental} The predicate was declared as either
  incremental dynamic or as incremental tabled.
%
