...
\begin{itemize}
\item The total number of check/insert operations for tables using call subsumption.

\item The number of distinct tables created for tables using call subsumption.

\item The total number of check/insert operations for tables using call variance.

\item The number of distinct tables created for tables using call variance.
...
\end{itemize}
 ...
 {\tt idg(+Nodes,+Edges)} where {\tt Nodes} is the number of nodes
