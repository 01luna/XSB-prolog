...
\noindent
{\large {\bf {\em This chapter documents beta-level software.  See
...
used.\footnote{\px{} has been tested on Ubuntu v. 18 and v. 20, and on
  Fedora 35; and Python versions 3.7, 3.8, 3.9 and 3.10were tested.
...
installs px.  \footnote{At some point, this confuration will be
...
\end{verbatim}
In addition the second consideration creates a file, {\tt
...
or other virtual environments.\footnote{This activation file updates
  ...
  the {\tt px} directory to {\tt PYTHONPATH}.} In {\tt bash} or {\tt
  zsh}, simply type
\begin{verbatim}
