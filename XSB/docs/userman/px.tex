...
\item {\tt 2} representing the truth value {\em undefined}. This means
  ...
  false in the Well-Funded Model of the program.  \ei
\noindent
...
\begin{example} \rm {\it Varying the number of arguments in queries and commands}
  ...
  the atom {\tt p(a)} was true, false,,or undefined in the
...
were added as a keyword argument, two arguments arguments would be
...
pass logical variables to XSB via strings.)  Finally, a call to {\tt
