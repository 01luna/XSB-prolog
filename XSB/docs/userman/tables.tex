...
negatively including {\tt tnot/1} and {\tt sk\_not/1}; rather, such
...
check.  
%
Similarly to the use of subgal abstraction, answer abstraction can be
declared by setting a value for the maximum depth of an answer and for
the action to take when an answer is encountered that reaches that
depth.
%
\bi
