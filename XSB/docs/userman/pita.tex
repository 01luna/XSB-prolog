...
(exclusiveness assumption),
  \end{itemize}
you can perform faster inference with an optimized version of PITA in package \texttt{pitaprism.P}. It accepts the same commands of \texttt{pita.P}.  \texttt{pitaprism.P} simulates PRISM and does not need CUDD and GLib.
