...
other module.  However for this process to work correctly other
...
{\tt xsbpy} like {\tt Python.h} or {\tt libpython<xxx>.so}.
...
\noindent
to install the Python itself (other version numbers of Python can be
used) and save the output of this installatoin.  Brew installs this
Python in a directory that for many users is not an execution path.
Therefore the path to the Python will need to be added to the user's
execution paths as specified in the brew installation output.  This
