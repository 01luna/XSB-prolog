...
edges into XSB as explaned below.  As an example of how to navigate
...
project and reflects the needs of that project.  Other applciations
...
\begin{itemize}
  ...
  \item {\tt Pos} ({\tt token.pos\_ }) is the coarse-grained part of
    speech for {\em token} accorrding to {\tt
...
including word vectors for 176 lanuages, the language-alignment tool
