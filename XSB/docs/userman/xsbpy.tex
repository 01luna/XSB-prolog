...
versions 3.5 -- 3.10 of Python and its libraries.\footnote{The {\tt
    xsbpy} configuration script was written by Michael Kifer.  In
  addition to Windows and Mac testing, it has been tested on Ubuntu,
  Fedora and CentOs Linuxes.}  The {\tt xsbpy} configuration script is
