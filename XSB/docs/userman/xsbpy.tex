...
{\tt find\_libpython} executed on a command line.  To run this
script, you will probably have to install it, using the command
{\tt pip install find-libpython}.

Running the {\tt find\_libpython} script will print out the name of
...
of {\tt xsbpym.xwam} is later than that of {\tt xsbpym.H} in {\tt
  <XSB>/packages/xsbpy/} and try again.  (You may alternatively simply
