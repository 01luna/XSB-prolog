...
\item[{reverse}] causes asserta to be used to assert the input terms,
  so the predicate will contain the file records in reverse order.
  This can significantly improve performanc if indexing is
  particularly weak.
