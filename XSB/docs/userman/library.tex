...
Sets the kind of unindexed profiling to perform.  If {\tt Par} is 0 no
unindexed logging will be done.  (This is the default.)  If {\tt Par}
is 1 each call to a dynamic predicate that cannot use any index (and
...
code.  If {\tt Par} is 2, logging is done as for 1, except every
