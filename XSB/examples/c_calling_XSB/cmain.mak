...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib xsb.lib /nologo /subsystem:console /incremental:yes /pdb:"$(OUTDIR)\cmain.pdb" /debug /machine:x64 /out:"$(OUTDIR)\cmain.exe" /pdbtype:sept /libpath:"..\..\config\x64-pc-windows\bin" 
LINK32_OBJS= \
	"$(INTDIR)\cmain.obj"
