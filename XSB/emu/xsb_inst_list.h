...
XSB_INST(0x86, variant_trie_no_cp_val, _variant_trie_no_cp_val, X,X,X,X);
XSB_INST(0x87, variant_trie_trust_val, _variant_trie_trust_val, X,X,X,X);
XSB_INST(0x88, variant_trie_try_val, _variant_trie_try_val, X,X,X,X);
XSB_INST(0x89, variant_trie_retry_val, _variant_trie_retry_val, X,X,X,X);
