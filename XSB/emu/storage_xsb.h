...
**
** $Id: storage_xsb.h,v 1.7 2010-05-21 23:58:10 kifer Exp $
** 
*/
...
extern STORAGE_HANDLE *storage_builtin(CTXTdeclc int builtin_number, Cell storage_name, CTXTdeclc prolog_term trie_type);
